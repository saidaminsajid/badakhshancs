...
$email = $_POST["email"];
$level = $_POST["level"];
$edit_command = "UPDATE admin SET name='$name' , lastname='$lastname' , username='$username' , firstpassword='$firstpassword' , secondpassword = '$secondpassword' , email='$email' , level='$level' WHERE id=$id";

$result = mysql_query($edit_command,$con);
if($result)
header("location: pass_cp.php");
else
...
رمز عبور اولی
</font></td><td><input type="password" name="firstpassword" size="30px" value="<?php echo $row["firstpassword"]; ?>"></td>
</tr><tr><td align="right"> <font color="#0000FF" size="+1">
رمز عبور دومی
</font></td><td><input type="password" name="secondpassword" size="30px" value="<?php echo $row["secondpassword"]; ?>"></td></tr><tr>
<td width="110px" align="right"> <font color="#0000FF" size="+1">
ایمیل آدرس
...
رتبه
</font></td><td colspan="2"><input type="text" name="level" size="30px" value="<?php echo $row["level"]; ?>"></td></tr>
