...
echo "<span style='color:green;'>موضوع را که شما انتخاب نموده بودید حذف شد!</span>";
if(isset($_GET["nodelete"]))
echo "<span style='color:red;'>موضوع را که انتخاب نموده بودید حذف نشد!</span>";
?>
<table class="ti_da" align="right">
<th>اسم ناشر</th><th width="4px"></th>
<th>تخلص ناشر</th><th width="4px"></th>
<th>ایمیل ناشر</th><th width="4px"></th>
<th>صنف ناشر</th><th width="4px"></th>
<th>عنوان موضوع</th><th width="4px"></th>
<th>تاریخ نشر</th><th width="4px"></th>
<th>ویرایش</th><th width="4px"></th>
<th>حذف</th>
<?php
do { ?>
<tr>
<td> <?php echo $names['name']; ?> </a></td><td></td>
<td> <?php echo $names['lastname']; ?> </a></td><td></td>
<td> <?php echo $names['email']; ?> </a></td><td></td>
<td> <?php echo $names['class']; ?> </a></td><td></td>
...
<td> <?php echo $names['date']; ?> </a></td><td></td>
<?php
echo "<td>" . "<a href='update_advertise.php?id=" . $names["id"] . 
"'><img src='../image/update.jpg'width='24px'></a></td>";
echo "<td>" . "</td>";
echo "<td>" . "<a href='delete_advertise.php?id=" . $names["id"] . 
