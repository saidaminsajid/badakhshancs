...
<form action="insert_advertise.php" method="post" enctype="multipart/form-data">
<table align="center" class="offer"><tr>
<td align="right"><label>اسم ناشر</label></td><td align="right"> <input type="text" name="name" /></td><br /></tr><tr>
<td align="right"><label>تخلص ناشر</label></td><td align="right"> <input type="text" name="lastname"><br /></td></tr><tr>
<td align="right"><label>ایمیل ناشر</label></td><td align="right"> <input type="text" name="email" /><br /></td></tr><tr>
<td align="right"><label>صنف ناشر</label></td><td align="right"> <input type="text" name="class" /></td><br /></tr><tr>
<td align="right"><label>عنوان موضوع</label></td><td align="right"> <textarea name="titleadvertise" cols="50" rows="3"></textarea><br /></td></tr><tr>
<td align="right"><label>متن کامل</label></td><td align="right"> <textarea name="advertise" cols="50" rows="10"></textarea><br /></td></tr><tr>
<td align="right"><label>تاریخ نشر</label></td><td align="right"> <input type="text" name="date" value="<?php echo date ('Y-m-d')?>" /></td><br /></tr><tr>
<td align="right"></td><td align="right"><label> <input type="submit" value="نشر" /></label></td></tr></table>
</form>

<?php
if(isset($_GET["try"]))
echo "<span style='color:red;'>معذرت میخواهیم موضوع شما نشر نشد لطفاً دوباره کشش نماید!</span>";
?>
</div>
