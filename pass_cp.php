...
$command = "SELECT * FROM admin ORDER BY id DESC";
...
<table align="right">
<tr>
<th>نمبرمسلسل</th><th width="10px"></th>
<th>نام</th><th width="10px"></th>
<th>نام کاربر</th><th width="10px"></th>
<th>ویرایش</th>
</tr>
<?php
do {
echo "<tr>";
echo "<td>" . $say["id"] . "</td>";echo "<td width='10px'>" . "</td>";
echo "<td>" . $say["name"] . "</td>";echo "<td width='10px'>" . "</td>";
echo "<td>" . $say["username"] . "</td>";echo "<td width='10px'>" . "</td>";
echo "<td>" . "<a href='updatepassword.php?id=" . $say["id"] . 
