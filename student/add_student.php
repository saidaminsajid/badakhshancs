...
<?php 
if(isset($_GET["error"]))
echo "<span style='color:red;'>معذرت میخواهیم پسورد شما یکسان نمیباشد!</span>"
?>
<?php
if(isset($_GET["try"]))
echo "<span style='color:red;'>معذرت میخواهیم راجستریشن انجام نشد لطفاً دوباره کوشش نماید!</span>";
?>
</div>
